...
export const battlePassTiers: BattlePassTier[] = [
  ...
  { level: 8, xp: 800, free: null, premium: { key: "bp8p", name: "Autumn Key", type: "item", item_key: "autumn-key", icon: "🗝️", rarity: "epic" } },
  ...
  { level: 13, xp: 1300, free: null, premium: { key: "bp13p", name: "Autumn Key", type: "item", item_key: "autumn-key", icon: "🗝️", rarity: "epic" } },
  ...
  { level: 18, xp: 1800, free: null, premium: { key: "bp18p", name: "Autumn Key", type: "item", item_key: "autumn-key", icon: "🗝️", rarity: "epic" } },
