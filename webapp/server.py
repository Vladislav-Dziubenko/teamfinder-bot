...
CASES_CONFIG = {
    "blue": {
        ...
        "dailyLimit": 1,
        "items": [
            {"key": "premium-medium", "name": "Премиум средний", "desc": "Премиум на 1 день: до 4 открытий кейсов в день (вместо 1), приоритет в поиске тиммейтов, расширенные анкеты игроков",         "image": "/premium-x4.webp", "rarity": "epic", "sell": 35, "weight": 8, "grantsPremium": True},
            {"key": "ak47", "name": "Скин AK-47", "desc": "Коллекционный скин-картинка для твоей анкеты. Показывается в профиле, не влияет на геймплей",         "image": "/ak47.webp", "rarity": "rare", "sell": 15, "weight": 20},
            {"key": "icon-skull", "name": "Череп", "desc": "Декоративная иконка для профиля 💀", "icon": "💀", "rarity": "common", "sell": 10, "weight": 18},
            {"key": "icon-fire", "name": "Пламя", "desc": "Декоративная иконка для профиля 🔥", "icon": "🔥", "rarity": "common", "sell": 10, "weight": 18},
            {"key": "icon-crown", "name": "Корона", "desc": "Декоративная иконка для профиля 👑", "icon": "👑", "rarity": "common", "sell": 10, "weight": 14},
            {"key": "icon-target", "name": "Прицел", "desc": "Декоративная иконка для профиля 🎯", "icon": "🎯", "rarity": "common", "sell": 10, "weight": 14},
            {"key": "icon-bolt", "name": "Молния", "desc": "Декоративная иконка для профиля ⚡", "icon": "⚡", "rarity": "common", "sell": 10, "weight": 14},
            {"key": "icon-star", "name": "Звезда", "desc": "Декоративная иконка для профиля ⭐", "icon": "⭐", "rarity": "common", "sell": 10, "weight": 14},
        ]
    },
    "jet": {
        "id": "jet",
        ...
        "dailyLimit": 99,
        "items": [
            {"key": "f16", "name": "F-16 Fighting Falcon", "desc": "5% шанс · +1000 ⭐ · +10 анкет/день · топ в поиске",         "image": "/f16.webp", "rarity": "legendary", "sell": 0, "weight": 3, "kind": "jet", "bonuses": {"stars": 1000, "searches": 10, "highlight_hours": 24}},
            {"key": "f15", "name": "F-15 Eagle", "desc": "8% шанс · +2500 монет · +5 анкет · топ 2-3 · бесплатное премиум-открытие",         "image": "/f15.webp", "rarity": "epic", "sell": 0, "weight": 12, "kind": "jet", "bonuses": {"coins": 2500, "searches": 5, "highlight_hours": 24, "free_gold_opens": 1}},
            {"key": "f14", "name": "F-14 Tomcat", "desc": "5% шанс · +2000 ⭐ · +25 премиум-открытий · +25 анкет · топ-1 на 3 дня",         "image": "/f14.webp", "rarity": "legendary", "sell": 0, "weight": 3, "kind": "jet", "bonuses": {"stars": 2000, "free_gold_opens": 25, "searches": 25, "highlight_hours": 48}},
            ...
            {"key": "ak47", "name": "Скин AK-47", "desc": "Коллекционный скин-картинка для профиля",         "image": "/ak47.webp", "rarity": "rare", "sell": 15, "weight": 25},
            {"key": "icon-skull", "name": "Череп", "desc": "Декоративная иконка 💀", "icon": "💀", "rarity": "common", "sell": 10, "weight": 12},
            {"key": "icon-fire", "name": "Пламя", "desc": "Декоративная иконка 🔥", "icon": "🔥", "rarity": "common", "sell": 10, "weight": 12},
            {"key": "icon-crown", "name": "Корона", "desc": "Декоративная иконка 👑", "icon": "👑", "rarity": "common", "sell": 10, "weight": 10},
            {"key": "icon-target", "name": "Прицел", "desc": "Декоративная иконка 🎯", "icon": "🎯", "rarity": "common", "sell": 10, "weight": 10},
            {"key": "icon-bolt", "name": "Молния", "desc": "Декоративная иконка ⚡", "icon": "⚡", "rarity": "common", "sell": 10, "weight": 10},
            {"key": "icon-star", "name": "Звезда", "desc": "Декоративная иконка ⭐", "icon": "⭐", "rarity": "common", "sell": 10, "weight": 10},
        ]
    },
    "gold": {
        "id": "gold",
